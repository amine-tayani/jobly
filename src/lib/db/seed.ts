...
const main = async () => {
	...
	const jobsData: (typeof jobs.$inferInsert)[] = [
		...
		},
		{
			...
			type: "hybrid",
			location: "Rabat, Morocco",
			description: "Lead product strategy and execution for our key initiatives...",
		},
		{
		...
		},
		{
			...
			type: "hybrid",
			location: "Rabat, Morocco",
			description: "Drive marketing strategy and campaigns to grow our brand...",
		},
		{
			...
			type: "hybrid",
			location: "Rabat, Morocco",
			description: "Build and maintain strong relationships with our key clients...",
		},
	]
